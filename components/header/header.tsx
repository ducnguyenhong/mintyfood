          ...
          <Link href="/">
            <a>
              <Flex alignItems="center">
                ...
                <Heading as="h3" fontSize={20} color={activeNavBar ? '#FFF' : '#e3594a'} ml={4} >Minty <Text as="span" fontSize={20} fontWeight={400} color={activeNavBar ? '#FFF' : "primary.1"}>Food</Text></Heading>
              </Flex>
            </a>
          </Link>
        </Flex>
