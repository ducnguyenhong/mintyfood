...
const ProductItemPreview: React.FC<ProductItemProps> = ({ item }) => {
  ...
  return (
    <Box>
      ...
      <Box px={10} mt={5}>
        <Flex alignItems="flex-start">
          ...
          <Flex gap={2} alignItems="center">
            <Text color="#828282" textDecoration="line-through" fontSize={15}>{formatPrice(initPrice)}</Text>
            <Text color="red" fontWeight={600} fontSize={18}>{formatPrice(curentPrice)}</Text>
          </Flex>
        </Flex>
        ...
        <Flex mt={3} alignItems="flex-start">
          ...
          <Badge colorScheme="green" variant='solid' pt={0.5}>Thức uống</Badge>
        </Flex>
        ...
        <Flex mt={3} alignItems="flex-start">
          ...
          <Flex flex={1}>
            <Text fontSize={13}>
              Sữa chua từ lâu đã là món ăn vặt, tráng miệng được rất nhiều người ưa thích, thường xuyên sử dụng trong các buổi tiệc sinh nhật hoặc sau các bữa cơm gia đình ngồi tráng miệng thư giãn bên nhau.
            </Text>
          </Flex>
        </Flex>
      </Box>
      ...
      <Flex px={10} mt={8}>
        <Text fontWeight={600} fontSize={15} w={40}>• Chọn số lượng</Text>
      ...
      <Flex justifyContent="center" mt={10}>
        <Button colorScheme="green" w={60}>
          <Flex alignItems="center" justifyContent="center" w={14} h={10} borderRadius={3}>
            ...
            <Text as="span" ml={3}>Thêm vào giỏ hàng</Text>
          </Flex>
        </Button>
      </Flex>
    </Box>
