...
const NewsList: React.FC = () => {
  const NEWS_DATA = useMemo(() => ([
    ...
    },
    {
      ...
      thumbnail: 'http://freshfoods.vn/images/cam-nang-nau-an-freshfoods.jpg',
      title: 'Cách làm sữa chua tại nhà',
      description: 'Cách làm sữa chua tại nhà làm sữa chua tại nhà làm sữa chua tại nhà làm sữa chua tại nhà Cách làm sữa chua tại nhà làm sữa chua tại nhà làm sữa chua tại nhà làm sữa chua tại nhà',
      createdAt: 1666504846000
    },
    {
      id: 3,
            ...
            <Flex key={id} mb={10} boxShadow="base" borderRadius={3} overflow="hidden">
              ...
              <Flex direction="column" flex={1} px={5} justifyContent="space-between" pb={3}>
                <Box>
                  <Link href={`${id}`}>
                    <a>
                      <Text color="#66BC42" fontWeight={700} fontSize={17}>{title}</Text>
                    </a>
                  </Link>
                ...
                <Flex alignItems="center" mt={1}>
                  <Flex alignItems="center">
                    ...
                    <Text fontSize={12} color="#828282" ml={1} mt={0.5}>{dayjs(createdAt).format('DD/MM/YYYY')}</Text>
                  </Flex>
                  <Flex alignItems="center" mt={-1}>
                    <Link href='/'>
                      <a>
                        <Badge ml={4} colorScheme="green" variant='solid' pt={0.5}>Thức uống</Badge>
                      </a>
                    </Link>
                  </Flex>
                </Flex>
